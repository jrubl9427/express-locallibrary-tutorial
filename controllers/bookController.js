...
exports.book_update_post = [
    ...
    // Process request after validtion and sanitation.
    (req, res, next) => {
        // Extract the validation errors from a request.
        const errors = validationResult(req);
        ...
        if (!errors.isEmpty()) {
            // There are errors. Render form again with anitized values/ error messages. Get all authors and genres for the form.
            async.parallel(
                {
                    authors(callback) {
                        Author.find(callback);
